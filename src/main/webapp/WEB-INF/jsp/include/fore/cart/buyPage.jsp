                    ...
                    <c:forEach items="${carts}" var="cart" varStatus="st">
                        <tr class="orderItemTR">
                            <td class="orderItemFirstTD">
                                <img class="orderItemImg" src="img/productSingle_middle/${cart.product.firstProductImage.id}.jpg">
                            </td>
                            <td class="orderItemProductInfo">
                                <a href="foreproduct?pid=${cart.product.id}" class="orderItemProductLink">
                                        ${cart.product.name}
                                </a>
                            ...
                            <td>
                                <span class="orderItemProductPrice">￥<fmt:formatNumber type="number"
                                                                                       value="${cart.product.promotePrice}"
                                                                                       minFractionDigits="2"/></span>
                            </td>
                            <td>
                                <span class="orderItemProductNumber">${cart.number}</span>
                            </td>
                            <td><span class="orderItemUnitSum">
						￥<fmt:formatNumber type="number" value="${cart.number*cart.product.promotePrice}"
                                           minFractionDigits="2"/>
						</span></td>
